...
imwrite(test.warpimg, 'temp_image.bmp');
command = ['SLICSuperpixelSegmentation temp_image.bmp  ' num2str(myopt.SLIC_spatial_proximity_weight) ' '  num2str(myopt.SLIC_sp_num)];
dos(command);
test.labels = readDAT(warpimg_size,'temp_image.dat');
